...
[Build](https://github.com/ghost-maintainer/ghost-shell/actions/workflows/build.yml)
[Release](https://github.com/ghost-maintainer/ghost-shell/releases/latest)
[License](LICENSE)
Platforms
...
- 📁 **SFTP browser** — transfer and manage remote files *(in progress)*
- 🗝️ **Encrypted keychain** — credentials secured behind a master password *(in progress)*
...
> **System Settings → Privacy & Security**, scroll down, and click **Open Anyway**. *(Required on
> macOS 15 Sequoia, which removed the old right-click → Open shortcut.)*
...
- [x] SSH connection backend (Rust)
- [x] Interactive terminal sessions
- [x] Encrypted keychain with master-password unlock
- [x] Host management UI, logs, settings & data import/export
- [ ] SFTP file browser & transfers
- [ ] Cloud backup and sync option via Google, 
